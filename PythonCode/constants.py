...
LOGFILENAME = 'logfile' # logfilename, without path
...
#DISPSIZE = (3840, 2160) # canvas size WINDOWS!!!!
DISPSIZE = (1680, 1050) # MY MAC
#SCREENSIZE = (58, 34) # physical display size in cm WINDOWS
SCREENSIZE = (34, 24) # MY MAC
MOUSEVISIBLE = False # mouse visibility
BGC = (0,0,0,0) # backgroundcolour
